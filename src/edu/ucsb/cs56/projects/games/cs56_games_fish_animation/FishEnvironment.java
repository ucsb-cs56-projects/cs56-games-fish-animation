...
/**
   ...
   Updated Fish Environment for S13
   @author Mathew Glodack, Christina Morris
   @version CS56, S13, project01
**/

public class FishEnvironment extends JFrame{
    Thread animate;
    ...
    /**
       Constructor for FishEnvironment. Creates a JFrame and a Jpanel that is placed inside of it. Animation is done on the JPanel
     **/
    public FishEnvironment(){//constructor
	...
	*/
    ...
    /**
       Main class for running FishEnvironment
    **/
